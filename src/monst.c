...
NEARDATA struct permonst mons[] = {
    ...
    MON("apprentice mind flayer", S_HUMANOID, LVL(7, 10, 5, 90, -8), (G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 4), ATTK(AT_TENT, AD_PHYS, 1, 4),
          ATTK(AT_TENT, AD_DRIN, 2, 1), NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("parrot", S_BAT, LVL(3, 20, 7, 0, -3), (G_GENO | 2),
	A(ATTK(AT_BITE, AD_PHYS, 1, 5), ATTK(AT_CLAW, AD_STUN, 1, 4), NO_ATTK, 
		NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(30, 30, MS_PARROT, 
		MZ_SMALL), 0, 0,
        M1_FLY | M1_ANIMAL | M1_NOHANDS | M1_HERBIVORE,
	M2_GREEDY | M2_JEWELS | M2_WANDER | M2_DOMESTIC,
...
#define SEDUCTION_ATTACKS_NO                                      \
    ...
    MON("samurai", S_HUMAN, LVL(10, 12, 10, 1, 3), G_NOGEN,
        ...
        M2_NOPOLY | M2_HUMAN | M2_STRONG | M2_COLLECT, M3_INFRAVISIBLE,
        12, HI_DOMESTIC),
    MON("scholar", S_HUMAN, LVL(10, 12, 10, 1, 3), G_NOGEN,
	A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK,
	  NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), 0, 0,
	M1_HUMANOID | M1_OMNIVORE,
    ...
    MON("Lord Sato", S_HUMAN, LVL(20, 12, 0, 30, 20), (G_NOGEN | G_UNIQ),
        ...
        M2_NOPOLY | M2_HUMAN | M2_PNAME | M2_PEACEFUL | M2_STRONG | M2_MALE
            | M2_COLLECT | M2_MAGIC,
        M3_CLOSE | M3_INFRAVISIBLE, 23, HI_LORD),
    MON("Leonhardt Euler", S_HUMAN, LVL(20, 12, 5, 40, 0), (G_NOGEN | G_UNIQ),
	A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_LEADER, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
    ...
    MON("Kurt Godel", S_HUMAN, LVL(20, 10, 2, 50, -13),
    	(G_NOGEN | G_UNIQ | G_NOCORPSE),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 6), ATTK(AT_CLAW, AD_SAMU, 2, 4),
          ATTK(AT_WEAP, AD_DRIN, 1, 4), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_NEMESIS, MZ_HUMAN), MR_STONE, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_HUMAN | M2_PNAME | M2_HOSTILE | M2_STRONG | M2_STALK
            | M2_NASTY | M2_MALE | M2_COLLECT | M2_MAGIC,
    ...
    MON("roshi", S_HUMAN, LVL(5, 12, 10, 10, 3), G_NOGEN,
        ...
        M2_NOPOLY | M2_HUMAN | M2_PEACEFUL | M2_STRONG | M2_COLLECT,
        M3_INFRAVISIBLE, 7, HI_DOMESTIC),
    MON("professor", S_HUMAN, LVL(5, 11, 10, 20, 3), G_NOGEN,
